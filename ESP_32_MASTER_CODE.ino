...
void vipDirectPushNode(float current,float voltage ,float power){
  ...
  // create an JSON object
   ...
   object["hardware_id"] = "dcsub003";
   object[ "data"]["current"] = current;
   object[ "data"]["voltage"] = voltage;
...
void powerMeter(){
  ...
  if (EA > 0){
    ...
    Serial.println("load is not connected");
  }
